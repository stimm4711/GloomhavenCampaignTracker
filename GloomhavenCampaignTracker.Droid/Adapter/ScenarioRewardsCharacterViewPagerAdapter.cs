...
{
    internal class ScenarioRewardsCharacterViewPagerAdapter : FragmentStatePagerAdapter
    {
        private readonly Context _context;
        private readonly List<DL_Character>  _characters;
        private Dictionary<int, SzenarioCharacterRewardsFragment> _characterFragments;

        public ScenarioRewardsCharacterViewPagerAdapter(Context context, FragmentManager fm, List<DL_Character> characters ) : base(fm)
        {
            _context = context;
            ...
            _characterFragments = new Dictionary<int, SzenarioCharacterRewardsFragment>();
        }
        ...
        {
            foreach(SzenarioCharacterRewardsFragment charfrag in _characterFragments.Values)
            {
                charfrag.Save();
            }
        }
        ...
        public override Fragment GetItem(int position)
        {
            ...
            {
                _characterFragments.Add(_characters[position].Id, SzenarioCharacterRewardsFragment.NewInstance(_characters[position].Id));
            }
