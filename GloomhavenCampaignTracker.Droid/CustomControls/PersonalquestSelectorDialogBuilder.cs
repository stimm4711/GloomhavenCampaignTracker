...
namespace GloomhavenCampaignTracker.Droid.CustomControls
{
    ...
    /// </summary>
    public sealed class PersonalquestSelectorDialogBuilder : AlertDialog.Builder
    {
        ...
        public PersonalquestSelectorDialogBuilder(Context context, int themeResId) : base(context, themeResId)
        {   
            ...
            _itemview = inflater.Inflate(Resource.Layout.alertdialog_personalquest_spinner_imageview, null);
        ...
        public PersonalquestSelectorDialogBuilder SetTitleColor(Color color)
        {
        ...
        public PersonalquestSelectorDialogBuilder SetCustomView(View view)
        {
