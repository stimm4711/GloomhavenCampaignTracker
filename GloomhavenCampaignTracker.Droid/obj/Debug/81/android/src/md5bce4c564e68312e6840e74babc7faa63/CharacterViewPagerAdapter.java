...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GloomhavenCampaignTracker.Droid.Adapter.CharacterViewPagerAdapter, Gloomhaven Campaign Tracker", CharacterViewPagerAdapter.class, __md_methods);
	}


	public CharacterViewPagerAdapter (android.support.v4.app.FragmentManager p0)
	{
		super (p0);
		if (getClass () == CharacterViewPagerAdapter.class)
			mono.android.TypeManager.Activate ("GloomhavenCampaignTracker.Droid.Adapter.CharacterViewPagerAdapter, Gloomhaven Campaign Tracker", "Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.Fragment", this, new java.lang.Object[] { p0 });
	}
