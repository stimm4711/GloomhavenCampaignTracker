...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GloomhavenCampaignTracker.Droid.CustomControls.CustomDialogBuilder, Gloomhaven Campaign Tracker", CustomDialogBuilder.class, __md_methods);
	}


	public CustomDialogBuilder (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CustomDialogBuilder.class)
			mono.android.TypeManager.Activate ("GloomhavenCampaignTracker.Droid.CustomControls.CustomDialogBuilder, Gloomhaven Campaign Tracker", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}


	public CustomDialogBuilder (android.content.Context p0, int p1)
	{
		super (p0, p1);
		if (getClass () == CustomDialogBuilder.class)
			mono.android.TypeManager.Activate ("GloomhavenCampaignTracker.Droid.CustomControls.CustomDialogBuilder, Gloomhaven Campaign Tracker", "Android.Content.Context, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}
