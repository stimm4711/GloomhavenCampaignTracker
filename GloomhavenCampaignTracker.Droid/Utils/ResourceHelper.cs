...
namespace GloomhavenCampaignTracker.Droid
{
    internal class ResourceHelper
    {
        ...
        {
            // classid index between 0 and 22
            classId = Math.Max(Math.Min(classId, 22), 0);
        ...
        private static readonly int[] m_classIcons =
        {
            ...
            Resource.Drawable.ic_class20icon,
            Resource.Drawable.ic_class21icon,
            Resource.Drawable.ic_class22icon,
            Resource.Drawable.ic_class23icon
        };
